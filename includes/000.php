<?php 
$result = mysqli_query($apizophim, "SELECT id,ten_phim,ten_goc,quoc_gia,nam_chieu,thumb,slug,trang_thai,thoi_luong,view FROM phim order by RAND() limit 12");
...
<li class="film-item">
					...
					<span class="current-quocgia"><img style="width:25px !important;position:static;" src="/css/<?php echo $quoc_gia; ?>.jpg"/></span>
