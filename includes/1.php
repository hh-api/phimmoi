<?php 
$result = mysqli_query($apizophim, "SELECT id,ten_phim,ten_goc,quoc_gia,nam_chieu,thumb,slug,trang_thai,view FROM phim WHERE `bole`='1' and `the_loai` NOT LIKE '%Hoạt%' order by time DESC limit 8");
