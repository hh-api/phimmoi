...
<div class="container" id="wrapper">
    <div class="left-content">
        ...
        <div class="block-film">
            <h2 class="caption">
            	<i class="fa fa-fire" aria-hidden="true"></i>Tìm Kiếm Phim <?php echo $s; ?>
            </h2>
...
<a class="page-numbers" title="Trang Đầu" href="<?php echo '/search.php?s='.$s.'&trang=1'; ?>"><i class="fa fa-angle-double-left"></i></a>
<?php if($trang > 2) {?>
<a class="page-numbers" href="<?php echo '/search.php?s='.$s.'&trang='.($trang - 2); ?>"><?php echo ($trang - 2); ?></a>
<?php } ?>
<?php if($trang > 1) {?>
<a class="page-numbers" href="<?php echo '/search.php?s='.$s.'&trang='.($trang - 1); ?>"><?php echo ($trang - 1); ?></a>
<?php } ?>
